...
from .views import (
    ...
    ApproveExpenseStepView, MarkExpensePaidView,
    BOTPendingExpensesView, BOTAllExpensesView,
    BOTRatifyExpenseView,
    ResubmitDeferredExpenseView,
    ExpenseStatsView,
)
...
urlpatterns = [
    ...
    path('bot-all/',                    BOTAllExpensesView.as_view(),           name='bot-all-expenses'),
    path('<uuid:pk>/bot-action/',       BOTRatifyExpenseView.as_view(),         name='bot-expense-action'),
    path('<uuid:pk>/resubmit-to-bot/',  ResubmitDeferredExpenseView.as_view(),  name='resubmit-to-bot'),
]